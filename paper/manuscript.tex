...
\hypersetup{colorlinks=true, linkcolor=black, citecolor=blue, urlcolor=blue, pdftitle={Classical Machine Learning for Kinase Drug-Target Affinity Prediction with Cold-Split Evaluation and Interpretable Feature Attribution}}

\begin{document}

\title{Drug Target Interaction Prediction Using Machine Learning}

\author{
\IEEEauthorblockN{Sivaani Janaswamy}
\IEEEauthorblockA{Artificial Intelligence and Data Science\\
CMR Institute of Technology, Bangalore, India\\
sija23aids@cmrit.ac.in}

\IEEEauthorblockN{Chandana Punneshetty}
\IEEEauthorblockA{Artificial Intelligence and Data Science\\
CMR Institute of Technology, Bangalore, India\\
cha23ainds@cmrit.ac.in}

\IEEEauthorblockN{Krupa S P}
\IEEEauthorblockA{Artificial Intelligence and Data Science\\
CMR Institute of Technology, Bangalore, India\\
krsp23ainds@cmrit.ac.in}

\IEEEauthorblockN{Kushi Shetty}
\IEEEauthorblockA{Artificial Intelligence and Data Science\\
CMR Institute of Technology, Bangalore, India\\
kush23ainds@cmrit.ac.in}
}
